    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 ftco-animate">
          ...
          <p>
            <img src="{{asset("assets/$theme/images/work-6.jpg")}}" alt="" class="img-fluid">
          </p>
          ...
          <p>
            <img src="{{asset("assets/$theme/images/work-4.jpg")}}" alt="" class="img-fluid">
          </p>
          ...
          <div class="about-author d-flex p-4 bg-light">
            <div class="bio mr-5">
              <img src="{{asset("assets/$theme/images/person_1.jpg")}}" alt="Image placeholder" class="img-fluid mb-4">
            </div>
            <div class="desc">
        ...
        <div class="col-lg-4 sidebar ftco-animate">
          ...
          <div class="sidebar-box bg-light ftco-animate">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image: url(../assets/thebigboss/images/work-1.jpg);"></a>
              <div class="text">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image: url(../assets/thebigboss/images/work-2.jpg);"></a>
              <div class="text">
                <h3 class="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="icon-calendar"></span> Sept. 12, 2019</a></div>
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image: url(../assets/thebigboss/images/work-3.jpg);"></a>
              <div class="text">
                <h3 class="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="icon-calendar"></span> Sept. 12, 2019</a></div>
