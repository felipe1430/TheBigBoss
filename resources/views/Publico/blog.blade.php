      ...
      <div class="row">
        <div class="col-lg-8 ftco-animate">
                  ...
                  <div class="blog-entry align-self-stretch d-md-flex">
                    <a href="blog-single.html" class="block-20" style="background-image: url('../assets/thebigboss/images/work-1.jpg');">
                    </a>
                ...
                <div class="col-md-12 d-flex ftco-animate">
                  <div class="blog-entry align-self-stretch d-md-flex">
                    <a href="blog-single.html" class="block-20" style="background-image: url('../assets/thebigboss/images/work-2.jpg');">
                    </a>
                    <div class="text d-block pl-md-4">
                        <div class="meta mb-3">
                        <div><a href="#">Sept. 12, 2019</a></div>
                ...
                <div class="col-md-12 d-flex ftco-animate">
                  <div class="blog-entry align-self-stretch d-md-flex">
                    <a href="blog-single.html" class="block-20" style="background-image: url('../assets/thebigboss/images/work-3.jpg');">
                    </a>
                    <div class="text d-block pl-md-4">
                        <div class="meta mb-3">
                        <div><a href="#">Sept. 12, 2019</a></div>
                ...
                <div class="col-md-12 d-flex ftco-animate">
                  <div class="blog-entry align-self-stretch d-md-flex">
                    <a href="blog-single.html" class="block-20" style="background-image: url('../assets/thebigboss/images/work-4.jpg');">
                    </a>
                    <div class="text d-block pl-md-4">
                        <div class="meta mb-3">
                        <div><a href="#">Sept. 12, 2019</a></div>
                ...
                <div class="col-md-12 d-flex ftco-animate">
                  <div class="blog-entry align-self-stretch d-md-flex">
                    <a href="blog-single.html" class="block-20" style="background-image: url('../assets/thebigboss/images/work-5.jpg');">
                    </a>
                    <div class="text d-block pl-md-4">
                        <div class="meta mb-3">
                        <div><a href="#">Sept. 12, 2019</a></div>
                ...
                <div class="col-md-12 d-flex ftco-animate">
                  <div class="blog-entry align-self-stretch d-md-flex">
                    <a href="blog-single.html" class="block-20" style="background-image: url('../assets/thebigboss/images/work-6.jpg');">
                    </a>
                    <div class="text d-block pl-md-4">
                        <div class="meta mb-3">
                        <div><a href="#">Sept. 12, 2019</a></div>
        ...
        <div class="col-lg-4 sidebar ftco-animate">
          ...
          <div class="sidebar-box bg-light ftco-animate">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image: url(../assets/thebigboss/images/image_1.jpg);"></a>
              <div class="text">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image: url(../assets/thebigboss/images/image_2.jpg);"></a>
              <div class="text">
                <h3 class="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="icon-calendar"></span> Sept. 12, 2019</a></div>
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image: url(../assets/thebigboss/images/image_3.jpg);"></a>
              <div class="text">
                <h3 class="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="icon-calendar"></span> Sept. 12, 2019</a></div>
