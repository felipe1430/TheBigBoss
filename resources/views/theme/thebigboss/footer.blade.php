        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">#1430 Constitucion. Sargento Aldea, chillan, Ñuble, chile</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+569 392 3929 210</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">TheBigBoss@gmail.com.com</span></a></li>
                </ul>
              </div>
          </div>
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados  | Desarrollado Por <i class="icon-heart color-danger" aria-hidden="true"></i><a href="" target="_blank">The Big Boss</a>
